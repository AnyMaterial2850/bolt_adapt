...
BEGIN
  ...
  -- Validate time formats (accept HH:MM)
...
-- Add helpful comment
COMMENT ON FUNCTION schedule_habit_reminders IS 'Schedule a reminder for a habit with strict HH:MM time format validation';